...
public class XTimber {
    ...
    public static abstract class Tree {
        ...
        private void prepareLog(int priority, Throwable t, String message, Object... args) {
            ...
            //输出方法路径
            MethodLocation type = methodLocation();
            message = (type == MethodLocation.NONE) ? message
                    : getMethodTrace(type, new StringBuilder()).append(message).toString();
         ...
         * 拼接方法路径
         *
         * @param type    Log输出方法路径的模式
         * @param builder 拼接器
         * @return 拼接器
         */
        private static StringBuilder getMethodTrace(MethodLocation type, StringBuilder builder) {
            ...
            if (stackTraceList != null && stackTraceList.length > 5) {
                ...
                builder.append("at")
                        .append("\t")
                        .append(type == MethodLocation.FULL ? className : "")
                        .append(type == MethodLocation.FULL ? "." : "")
                        .append(methodName)
                        .append("(")
                        .append(fileName)
                        .append(":")
