...
//    private static final String TAG = "JCameraView";
    ...
    //录制视频比特率
    public static final int MEDIA_QUALITY_HIGH_X = 24 * 100000;
    ...
    public JCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        iconBack = a.getResourceId(R.styleable.JCameraView_iconBack, 0);
        ...
        openFlashLight = a.getBoolean(R.styleable.JCameraView_openFlashLight, openFlashLight);
        a.recycle();
        initData();
        initView();
    }
    ...
    private void initView() {
        ...
        mBack = (ImageView) view.findViewById(R.id.image_back);
        if (iconBack > 0) {
            mBack.setImageResource(iconBack);
...
//        });
    ...
    public void onResume() {
        ...
        CameraInterface.getInstance().setSwitchView(mSwitchCamera, mFlashLamp, mBack);
    ...
    public void confirmState(int type) {
        switch (type) {
            case TYPE_VIDEO:
                ...
                Intent mediaScanIntent = new Intent(Intent.ACTION_MEDIA_SCANNER_SCAN_FILE, Uri.fromFile(new File(videoUrl)));
