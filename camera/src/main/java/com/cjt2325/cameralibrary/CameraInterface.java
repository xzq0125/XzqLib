...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    public void setSwitchView(ImageView mSwitchView, ImageView mFlashLamp, ImageView mBack) {
    ...
    private void rotationAnimation() {
        ...
        if (rotation != angle) {
            ...
            ObjectAnimator animB = ObjectAnimator.ofFloat(mBack, "rotation", start_rotaion, end_rotation);
            AnimatorSet set = new AnimatorSet();
            set.playTogether(animC, animF, animB);
            set.setDuration(500);
            set.start();
            rotation = angle;
        }
